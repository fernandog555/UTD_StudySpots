...
Feature Development: Developers should create new branches off the development branch for individual features or fixes. However, for this repo, it is ok to commit directly to the development branch, because of the smaller size of the project. Feel free to use these branching conventions if you feel it is necessary to avoid complexity. 
...
## Example:
```
git checkout -b quac88/feat/add-player-class
```
...
- [ ] I am following the [branch naming rules](contributing.md#format-for-branch-names)
